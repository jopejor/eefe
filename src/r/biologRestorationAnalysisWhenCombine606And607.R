...
direccio$CondenseComparison = direccio$comparison
direccio$CondenseComparison = sub(direccio$CondenseCompariso,pattern="Partially Restored",replacement = "Restorative")
direccio$CondenseComparison = sub(direccio$CondenseCompariso,pattern="Over-restored",replacement = "Restorative")
direccio$CondenseComparison = sub(direccio$CondenseCompariso,pattern="Restored",replacement = "Restorative")
direccio$CondenseComparison = sub(direccio$CondenseCompariso,pattern="Uninformative",replacement = "Other")
direccio$CondenseComparison[is.na(direccio$CondenseComparison)] = "Other"


#pdf("BiologRestorationForBothByConditionTreatmentStrategy.pdf")
ggplot(direccio) + aes(x = PC, fill =CondenseComparison)+
  geom_bar(position = "fill") +
  ylab("Relative Abundance") + 
  xlab("Environment")+facet_grid(Treatment~referencia~Strategy)
#dev.off()